...
const SERVICES: Service[] = [
  {
    ...
    text: 'Высотные работы на жилых и промышленных объектах любой сложности — без лесов и автовышек.',
  },
  {
    icon: Building2,
    title: 'Капремонт межпанельных швов',
    text: 'Демонтаж старого утеплителя, замена ППУ, наружная герметизация и финишное покрытие. Гарантия до 5 лет.',
  },
  {
    icon: Droplets,
    title: 'Герметизация',
  ...
  },
  {
    ...
    text: 'Витражи, балконы, фасадное остекление высотных зданий. Без разводов и потёков, в любую погоду.',
  },
  {
    icon: Wind,
    title: 'Кондиционеры',
