...
const STEPS = [
  ...
  },
  {
    n: '03',
    title: 'Работы',
    text: 'Аккуратно, в оговорённые сроки, без ущерба отделке и соседям. Каждый день — фотоотчёт.',
  },
  {
    n: '04',
    title: 'Сдача',
    text: 'Принимаете лично или по видео. Гарантия в договоре, контакты для обслуживания.',
  },
]
    ...
    <section id="process" className="relative px-5 py-28 sm:px-8 sm:py-36">
      <div className="mx-auto max-w-5xl">
        <SectionHeader
          ...
          subtitle="Прозрачно с первого звонка."
        />
